     ...
     myApp.directive('brightcovePlayer', function ($timeout) {
         return {
             restrict: 'E',
             link: function (scope, element, attr) {
                 ...
                 var addPlayer = function () {
                     ...
                     var templateVideoId = '<video ' + attr.poster + ' id=\"' + bcPlayerId + '\" data-video-id=\"' + attr.videoId + '\" data-account=\"' + attr.accountId + '\" data-player=\"' + attr.playerId + '\" data-embed=\"default\" class=\"video-js\" controls ' + attr.addons + ' ' + attr.autoplay + ' playsinline width=\"100%\"></video>';

                     // if video loaded in brightcove player by external url
                     var templateVideoUrl = '<video ' + attr.poster + ' id=\"' + bcPlayerId + '\" data-player=\"' + attr.playerId + '\" data-embed=\"default\" data-application-id class=\"video-js\" controls ' + attr.addons + ' ' + attr.autoplay + ' playsinline width=\"100%\"><source src=\"' + attr.videoUrl + '\"></video>';
